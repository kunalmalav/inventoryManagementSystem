...
class BillClass:
    ...
    #    billing button
       ...
       btn_print=Button(billmenuframe,text='print',command=self.print_bill,font=("goudy old style",15,"bold"),bg="light green",fg="white",cursor="hand2")
       btn_print.place(x=2,y=80,width=120,height=50)

       btn_clear_all=Button(billmenuframe,text='clear all',font=("goudy old style",15,"bold"),bg="grey",fg="white",command=self.clear_all,cursor="hand2")
       btn_clear_all.place(x=124,y=80,width=120,height=50)

       btn_generate=Button(billmenuframe,text='generate/save bill',font=("goudy old style",15,"bold"),bg="#009688",fg="white",command=self.generate_bill,cursor="hand2")
       btn_generate.place(x=246,y=80,width=60,height=50)
       
    #    footer
       footer=Label(self.root,text="IMS inventory management system | developed by inventory engine group \n for any technical issue contact tejas",font=("times new roman",11,"bold"),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
